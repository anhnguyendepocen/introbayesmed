...
I have setup a class chatroom on [Slack](https://introbayesmed20.slack.com). this space is intended so that we can have asynchronous communication, but also so that you (students) can communicate with one another.
